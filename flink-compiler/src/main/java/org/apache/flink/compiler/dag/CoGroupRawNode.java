...
import org.apache.flink.compiler.operators.CoGroupRawDescriptor;
...
public class CoGroupRawNode extends TwoInputNode {
	 ...
	 */
	@Override
	public CoGroupRawOperatorBase<?, ?, ?, ?> getPactContract() {
		return (CoGroupRawOperatorBase<?, ?, ?, ?>) super.getPactContract();
	}
	...
	private List<OperatorDescriptorDual> initializeDataProperties() {
		...
		CoGroupRawOperatorBase<?, ?, ?, ?> cgc = getPactContract();
