...
/**
 * An input format to parse ENVI files into Triplets which represent tile objects.
 ...
 */
public class TileInputFormat<T extends Tuple3<String, byte[], byte[]>> extends FileInputFormat<T> {
